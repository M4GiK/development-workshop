	...
	if(isset($_POST["Submit"]))
	{
			...
			if(count($errors) == 0)
			{
				...
				if(!isset($_COOKIE["SG_params"]))
				{
					...
					//echo $strparams;
					setcookie('NGA_params', $strparams, time() + 3600);
					//header("location:wait.php");
					generateExecution($_SESSION["login"]["username"],$_POST, $strparams, 5);
				}
				else
				{
					//echo"wlas";
...
<form id="form1" name="form1" method="post" action="NewGeneticAlgorithmParams.php">
