...
<? 
	if($_GET["message"] == "max")
		echo "<p align=\"center\"><img src=\"../../frontend/img/icons/exclamation.png\"/>&nbsp;You cannot launch new executions; you have reached the maximum number of allowed  executions per day.</p>";
	else
		echo "<p align=\"center\"><img src=\"../../frontend/img/icons/accept.png\"/>&nbsp; 	The execution was successfully submitted</p>";
	echo "<p align=\"center\"><img src=\"../../frontend/img/icono_amarill_square.gif\"/><a href=\"executions.php\">&nbsp;back</a></p>";
?>
</div>
<br />
<br />
