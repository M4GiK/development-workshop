...
<?
	...
	function getTabs($seccion)
	{
		if($seccion == "result" || $seccion =="")
			...
			echo "<li class=\"pestanas\"><a href=result.php?username=".$_GET["username"]."&date=".$_GET["date"]."&section=result>Result</a></li>";	
			
		if($seccion == "stats_result")
			echo "<li class=\"pestana_selec\"><strong>Result stats</strong></li>";
		else
			echo "<li class=\"pestanas\"><a href=result.php?username=".$_GET["username"]."&date=".$_GET["date"]."&section=stats_result>Result stats</a></li>";		
			
		if($seccion == "trace")
			echo "<li class=\"pestana_selec\"><strong>Trace</strong></li>";
		else
			echo "<li class=\"pestanas\"><a href=result.php?username=".$_GET["username"]."&date=".$_GET["date"]."&section=trace>Trace</a></li>";	
		
		if($seccion == "stats_trace")
			echo "<li class=\"pestana_selec\"><strong>Trace stats</strong></li>";
		else
			echo "<li class=\"pestanas\"><a href=result.php?username=".$_GET["username"]."&date=".$_GET["date"]."&section=stats_trace>Trace stats</a></li>";			
	}
	...
	function getTrace($username,$date, $trace)
	{
		...
		echo "<form id=\"form1\" name=\"form1\" method=\"get\" action=\"result.php\">";
	...
	<div id="central">
		<div id="primer_menu">
			<ul class="ul_primermenu">
				...
				<li class="li_primermenu"><a href="userAccount/executions.php" class="link_primermenu">Back</a></li>
			</ul>
		</div>	
