		...
		switch($_SESSION['presentation']->getLanguage())
		{
			case "ES":
						echo "<li class=\"li_idioma\"><span class=\"link_idioma_sel\">Castellano</span></li>
							<li class=\"li_idioma\"><a href=\"events.php?lang=CA&amp;id=".$_GET["id"]."\" class=\"link_idioma\">Catal&agrave;</a></li>
							<li class=\"li_idioma\"><a href=\"events.php?lang=EN&amp;id=".$_GET["id"]."\" class=\"link_idioma\">English</a></li>";
							break;

			case "EN":
						echo "	<li class=\"li_idioma\"><a href=\"events.php?lang=ES&amp;id=".$_GET["id"]."\" class=\"link_idioma\">Castellano</a></li>
							<li class=\"li_idioma\"><a href=\"events.php?lang=CA&amp;id=".$_GET["id"]."\" class=\"link_idioma\">Catal&agrave;</a></li>
...
<div id="menu">
<? $_SESSION['presentation']->loadMenuByName("Events");?>
</div>
<div id="central">
...
<?
	$_SESSION['presentation']->loadEvents($filter, $_GET["day"]);
?>
</div>
