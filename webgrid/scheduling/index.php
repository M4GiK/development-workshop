		...
		switch($_SESSION['presentation']->getLanguage())
		{
			case "ES":
						echo "<li class=\"li_idioma\"><span class=\"link_idioma_sel\">Castellano</span></li>
							<li class=\"li_idioma\"><a href=\"index.php?lang=CA\" class=\"link_idioma\">Catal&agrave;</a></li>
							<li class=\"li_idioma\"><a href=\"index.php?lang=EN\" class=\"link_idioma\">English</a></li>";
							break;

			case "EN":
						echo "<li class=\"li_idioma\"><a href=\"index.php?lang=ES\"class=\"link_idioma\">Castellano</a></li>
							<li class=\"li_idioma\"><a href=\"index.php?lang=CA\" class=\"link_idioma\">Catal&agrave;</a></li>
...
?>
<div id="contenido">
<div id="cabecera"><? include "header.htm";?>
</div>
<div id="idioma">
<ul class="ul_idioma">
<? getLanguageMenu();?>
...
<div id="menu">
<? $_SESSION['presentation']->loadMenu(false);?>
</div>
<div id="central">
<div id="submenu">
<? 
...
<?
	...
	{
	case "benchmarking":
		include_once "./benchmarking/index.php";
	break;
	}
?>
</div>
