	...
	*/
	...
	class newsManager
	{
		...
		function addNew($info)
		{
			...
			$sql = "INSERT INTO noticias (titular_es,titular_en,titular_ca,cuerpo_es,cuerpo_en,cuerpo_ca,fecha_exp)VALUES('$titular_es','$titular_en','$titular_ca','$cuerpo_es','$cuerpo_en','$cuerpo_ca',$fecha_exp)";
