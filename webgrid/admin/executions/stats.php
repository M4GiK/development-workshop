...
<h1 align="center">Estadisticas Ejecuciones</h1>
<img src="buildStats.php?graph=status" width="450"height="250" />
...
/ 20 
  ...
  <input type="submit" name="interval" value="Ver grafica" />
  </form>
  <br />
  <br />
  <img src="buildStats.php?graph=executions_interval<? echo "&month_ini=$month_ini&year_ini=$year_ini&month_fin=$month_fin&year_fin=$year_fin"; ?>" width="600"height="400" />
