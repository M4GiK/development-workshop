...
<?
	...
	if($execm->removeExecution($username,$fecha))
		echo "<p align=\"center\"><img src=\"../../frontend/img/icons/accept.png\"/>&nbsp;Se ha borrado la ejecuci&oacute;n con &eacute;xito!</p>";
	else
		echo "<p align=\"center\"><img src=\"../../frontend/img/icons/exclamation.png\"/>&nbsp;No se ha podido borrar la ejecuci&oacute;n<p/>";
