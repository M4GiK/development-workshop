...
<?
	...
	{
		removeJobs();
		installJobs($_POST["informe"],"../crontab.txt");
		listJobs();
	}
	$cm = new configManager();
	if($cm->editAvisos($_POST))
	...
	echo "<p align=\"center\"><img src=\"../../frontend/img/icono_amarill_square.gif\"/><a href=\"avisos.php\">&nbsp;volver</a></p>";
?>
</div>
<br />
<br />
