...
<h1>Mail</h1>
<form id="form1" method="post" action="saveMail.php">
<table width="60%" cellspacing="0" cellpadding="0" class="tabladatos">
  <tr>
    <th scope="row" class="th_tabladatos">Mail</th>
    <td class="td_tabladatos_PAR"><input name="mail" type="text" id="mail" value="<? echo $mail;?>"/></td>
  </tr>
  <tr>
