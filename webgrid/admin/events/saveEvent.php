	...
	switch($action)
	{
		case "edit":	
					if($em->editEvent($_POST,$event))
							echo "<p align=\"center\"><img src=\"../../frontend/img/icons/accept.png\"/>&nbsp;Se ha modificado el evento con &eacute;xito!</p>";
					else
		...
		case "new":
					if($em->addEvent($_POST))
						echo "<p align=\"center\"><img src=\"../../frontend/img/icons/accept.png\"/>&nbsp;Se ha a&ntilde;adido el evento con &eacute;xito!</p>";
					else
						echo "<p align=\"center\"><img src=\"../../frontend/img/icons/exclamation.png\"/>&nbsp;No se ha podido a&ntilde;adir el evento<p/>";
