...
<?
	...
	switch($action)
	{
		case "removeSubsection":	
					if($cms->removeSubsection($section,$subsection))
						echo "<p align=\"center\"><img src=\"../../frontend/img/icons/accept.png\"/>&nbsp;Se ha eliminado la seccion con &eacute;xito!</p>";
					else
					echo "<p align=\"center\"><img src=\"../../frontend/img/icons/exclamation.png\"/>&nbsp;No se ha podido eliminar la sunsecci&oacute;<p/>";
					break;
					
		case "removeSection":
							if($cms->removeSection($section))
							echo "<p align=\"center\"><img src=\"../../frontend/img/icons/accept.png\"/>&nbsp;Se ha eliminado la seccion con &eacute;xito!</p>";
							else
								echo "<p align=\"center\"><img src=\"../../frontend/img/icons/exclamation.png\"/>&nbsp;No se ha podido eliminar la secci&oacute;<p/>";	
