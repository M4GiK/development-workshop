	...
	switch($action)
	{
		case "edit":	
					if($newsm->editNew($info,$new))
							echo "<p align=\"center\"><img src=\"../../frontend/img/icons/accept.png\"/>&nbsp;Se ha modificado la noticia con &eacute;xito!</p>";
					else
		...
		case "new":
							if($newsm->addNew($info))
								echo "<p align=\"center\"><img src=\"../../frontend/img/icons/accept.png\"/>&nbsp;Se ha a&ntilde;adido la noticia con &eacute;xito!</p>";
							else
								"<p align=\"center\"><img src=\"../../frontend/img/icons/exclamation.png\"/>&nbsp;No se ha podido a&ntilde;adir la noticia<p/>";	
