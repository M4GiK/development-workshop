...
<?
	...
	if($newsm->removeNew($new))
		echo "<p align=\"center\"><img src=\"../../frontend/img/icons/accept.png\"/>&nbsp;Se ha eliminado la noticia con &eacute;xito!</p>";
	else
		"<p align=\"center\"><img src=\"../../frontend/img/icons/exclamation.png\"/>&nbsp;No se ha podido eliminar la noticia<p/>";		
