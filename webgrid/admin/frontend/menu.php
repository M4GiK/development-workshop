...
<?php
	...
	{	
		...
		for($i = 0; $i < $n; $i++)
		{
			...
			{	
				if($ajax)
					echo urlencode("<li><a id=\"menu-$link\" href=\"$href\" class=\"menusel\">$name</a></li>");
				else
					echo "<li><a id=\"menu-$link\" href=\"$href\" class=\"menusel\">$name</a></li>";
			}
			else
			{	
				if($ajax)	
					echo urlencode("<li><a id=\"menu-$link\" href=\"$href\" class=\"menuunsel\">$name</a></li>");
				else
					echo"<li><a id=\"menu-$link\" href=\"$href\" class=\"menuunsel\">$name</a></li>";	
			}
		}
